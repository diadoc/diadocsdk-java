...
public final class CertificateListProtos {
  ...
  public interface CertificateListOrBuilder extends
      // @@protoc_insertion_point(interface_extends:Diadoc.Api.Proto.Certificates.CertificateList)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
    java.util.List<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2> 
        getCertificatesList();
    /**
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
    Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2 getCertificates(int index);
    /**
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
     ...
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
    java.util.List<? extends Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2OrBuilder> 
        getCertificatesOrBuilderList();
    /**
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
    Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2OrBuilder getCertificatesOrBuilder(
        int index);
  }
  /**
   * Protobuf type {@code Diadoc.Api.Proto.Certificates.CertificateList}
   */
  public static final class CertificateList extends
      com.google.protobuf.GeneratedMessage implements
      // @@protoc_insertion_point(message_implements:Diadoc.Api.Proto.Certificates.CertificateList)
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                certificates_ = new java.util.ArrayList<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2>();
                mutable_bitField0_ |= 0x00000001;
              }
              certificates_.add(input.readMessage(Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Diadoc.Api.Proto.Certificates.CertificateListProtos.internal_static_Diadoc_Api_Proto_Certificates_CertificateList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList.class, Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList.Builder.class);
    }
    ...
    private java.util.List<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2> certificates_;
    /**
     * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
     */
    public java.util.List<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2> getCertificatesList() {
    ...
    public static Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList parseFrom(
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:Diadoc.Api.Proto.Certificates.CertificateList)
        Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateListOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.Certificates.CertificateListProtos.internal_static_Diadoc_Api_Proto_Certificates_CertificateList_descriptor;
      }
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList other) {
        if (other == Diadoc.Api.Proto.Certificates.CertificateListProtos.CertificateList.getDefaultInstance()) return this;
        if (certificatesBuilder_ == null) {
      ...
      private void ensureCertificatesIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          certificates_ = new java.util.ArrayList<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2>(certificates_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2OrBuilder> certificatesBuilder_;
      ...
      public Builder setCertificates(
          int index, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2 value) {
        if (certificatesBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCertificates(
          int index, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder builderForValue) {
        if (certificatesBuilder_ == null) {
          ensureCertificatesIsMutable();
       ...
       * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
       */
      public Builder addCertificates(Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2 value) {
        if (certificatesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCertificates(
          Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder builderForValue) {
        if (certificatesBuilder_ == null) {
          ensureCertificatesIsMutable();
      ...
      public Builder addAllCertificates(
          java.lang.Iterable<? extends Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2> values) {
        if (certificatesBuilder_ == null) {
          ensureCertificatesIsMutable();
       ...
       * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
       */
      public Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder getCertificatesBuilder(
          int index) {
       ...
       * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
       */
      public Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder addCertificatesBuilder() {
        return getCertificatesFieldBuilder().addBuilder(
            Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.getDefaultInstance());
      }
      /**
       * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
       */
      public Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder addCertificatesBuilder(
          int index) {
        return getCertificatesFieldBuilder().addBuilder(
            index, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.getDefaultInstance());
      }
      /**
       * <code>repeated .Diadoc.Api.Proto.Certificates.CertificateInfoV2 Certificates = 1;</code>
       */
      public java.util.List<Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder> 
           getCertificatesBuilderList() {
        return getCertificatesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2.Builder, Diadoc.Api.Proto.Certificates.CertificateInfoV2Protos.CertificateInfoV2OrBuilder> 
          getCertificatesFieldBuilder() {
        if (certificatesBuilder_ == null) {
      ...
      // @@protoc_insertion_point(builder_scope:Diadoc.Api.Proto.Certificates.CertificateList)
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_Diadoc_Api_Proto_Certificates_CertificateList_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_Diadoc_Api_Proto_Certificates_CertificateList_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\"Certificates/CertificateList.proto\022\035Di" +
      "adoc.Api.Proto.Certificates\032$Certificate" +
      "s/CertificateInfoV2.proto\"Y\n\017Certificate" +
      "List\022F\n\014Certificates\030\001 \003(\01320.Diadoc.Api." +
      "Proto.Certificates.CertificateInfoV2B\027B\025" +
      "CertificateListProtos"
    };
    ...
    internal_static_Diadoc_Api_Proto_Certificates_CertificateList_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_Diadoc_Api_Proto_Certificates_CertificateList_descriptor,
