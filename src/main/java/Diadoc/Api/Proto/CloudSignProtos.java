...
public final class CloudSignProtos {
  ...
  public interface CloudSignFileOrBuilder extends
     ...
     * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
     */
    Diadoc.Api.Proto.ContentV2.Content_v2 getContent();
    /**
     * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
     */
    Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder getContentOrBuilder();
  ...
  public static final class CloudSignFile extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              Diadoc.Api.Proto.ContentV2.Content_v2.Builder subBuilder = null;
              if (((bitField0_ & 0x00000001) == 0x00000001)) {
                subBuilder = content_.toBuilder();
              }
              content_ = input.readMessage(Diadoc.Api.Proto.ContentV2.Content_v2.PARSER, extensionRegistry);
              if (subBuilder != null) {
     ...
     * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
     */
    public Diadoc.Api.Proto.ContentV2.Content_v2 getContent() {
      return content_;
    }
    /**
     * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
     */
    public Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder getContentOrBuilder() {
      return content_;
    }
    ...
    public static final class Builder extends
      ...
      private Diadoc.Api.Proto.ContentV2.Content_v2 content_ = Diadoc.Api.Proto.ContentV2.Content_v2.getDefaultInstance();
       ...
       * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
       */
      public Builder setContent(Diadoc.Api.Proto.ContentV2.Content_v2 value) {
        if (contentBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
       */
      public Builder mergeContent(Diadoc.Api.Proto.ContentV2.Content_v2 value) {
        if (contentBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001) &&
              content_ != Diadoc.Api.Proto.ContentV2.Content_v2.getDefaultInstance()) {
            content_ =
              Diadoc.Api.Proto.ContentV2.Content_v2.newBuilder(content_).mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
          onChanged();
       ...
       * <code>optional .Diadoc.Api.Proto.Content_v2 Content = 1;</code>
       */
      public Diadoc.Api.Proto.ContentV2.Content_v2.Builder getContentBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
  ...
  public interface CloudSignConfirmResultOrBuilder extends
     ...
     */
    java.util.List<Diadoc.Api.Proto.ContentV2.Content_v2> 
        getSignaturesList();
    /**
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    Diadoc.Api.Proto.ContentV2.Content_v2 getSignatures(int index);
    /**
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
     ...
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    java.util.List<? extends Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder> 
        getSignaturesOrBuilderList();
    /**
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder getSignaturesOrBuilder(
        int index);
  }
  /**
  ...
  public static final class CloudSignConfirmResult extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                signatures_ = new java.util.ArrayList<Diadoc.Api.Proto.ContentV2.Content_v2>();
                mutable_bitField0_ |= 0x00000001;
              }
              signatures_.add(input.readMessage(Diadoc.Api.Proto.ContentV2.Content_v2.PARSER, extensionRegistry));
              break;
            }
          }
        }
     ...
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    public java.util.List<Diadoc.Api.Proto.ContentV2.Content_v2> getSignaturesList() {
      return signatures_;
    }
    /**
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    public java.util.List<? extends Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder> 
        getSignaturesOrBuilderList() {
      return signatures_;
    }
    /**
     ...
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    public Diadoc.Api.Proto.ContentV2.Content_v2 getSignatures(int index) {
      return signatures_.get(index);
    }
    /**
     * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
     */
    public Diadoc.Api.Proto.ContentV2.Content_v2OrBuilder getSignaturesOrBuilder(
        int index) {
      return signatures_.get(index);
    }
    ...
    public static final class Builder extends
       ...
       * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
       */
      public Builder addSignatures(Diadoc.Api.Proto.ContentV2.Content_v2 value) {
        if (signaturesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
       */
      public Diadoc.Api.Proto.ContentV2.Content_v2.Builder getSignaturesBuilder(
          int index) {
       ...
       * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
       */
      public Diadoc.Api.Proto.ContentV2.Content_v2.Builder addSignaturesBuilder() {
       ...
       * <code>repeated .Diadoc.Api.Proto.Content_v2 Signatures = 1;</code>
       */
      public java.util.List<Diadoc.Api.Proto.ContentV2.Content_v2.Builder> 
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "s\030\001 \003(\0132\034.Diadoc.Api.Proto.Content_v2\"K\n" +
      "\026AutosignReceiptsResult\022\033\n\023SignedReceipt" +
      "sCount\030\001 \002(\003\022\024\n\014NextBatchKey\030\002 \002(\tB\024B\017Cl",
      "oudSignProtos\270\001\001"
    };
