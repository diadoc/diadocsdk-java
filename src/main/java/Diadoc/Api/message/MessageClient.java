...
public class MessageClient {
    ...
    public Message getMessageV6(String currentBoxId, String messageId, String entityId) throws DiadocSdkException {
        return getMessageV6(currentBoxId, messageId, entityId, false, false);
    }

    public Message getMessageV6(String currentBoxId, String messageId, String entityId, boolean withOriginalSignature) throws DiadocSdkException {
        return getMessageV6(currentBoxId, messageId, entityId, withOriginalSignature, false);
    }

    public Message getMessageV6(String currentBoxId, String messageId, boolean withOriginalSignature, boolean injectEntityContent) throws DiadocSdkException {
        return getMessageV6(currentBoxId, messageId, null, withOriginalSignature, injectEntityContent);
    }

    public Message getMessageV6(String currentBoxId, String messageId) throws DiadocSdkException {
        return getMessageV6(currentBoxId, messageId, false, false);
    }

    public Message getMessageV6(String currentBoxId, String messageId, boolean withOriginalSignature) throws DiadocSdkException {
        return getMessage(currentBoxId, messageId, withOriginalSignature, false);
    }
    ...
    public MessagePatch postMessagePatchV4(MessagePatchToPostV2 patch) throws DiadocSdkException {
        return postMessagePatchV4(patch, null);
    }

    public MessagePatch postMessagePatchV4(MessagePatchToPostV2 patch, @Nullable String operationId) throws DiadocSdkException {
        if (patch == null) {
            throw new IllegalArgumentException("patch");
        }

        try {
            var uriBuilder = new URIBuilder(diadocHttpClient.getBaseUrl()).setPath("/V4/PostMessagePatch");
            if (operationId != null) {
                uriBuilder.addParameter("operationId", operationId);
            }
            var request = RequestBuilder
