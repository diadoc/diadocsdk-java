...
public class GenerateClient {
    ...
    public GeneratedFile generateUniversalCorrectionTransferDocumentXmlForSeller(
        ...
        return generateUniversalCorrectionTransferDocumentXmlForSeller(ucdInfo, disableValidation, documentVersion, null);
    }

    public GeneratedFile generateUniversalCorrectionTransferDocumentXmlForSeller(
            UniversalCorrectionDocumentSellerTitleInfo ucdInfo,
            @Nullable Boolean disableValidation,
            @Nullable String documentVersion,
            @Nullable Boolean correction) throws DiadocSdkException {
        if (ucdInfo == null) {
            throw new IllegalArgumentException("info");
        }
