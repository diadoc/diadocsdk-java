...
public class CounteragentGroupClient {
    ...
    public CounteragentGroupProtos.CounteragentGroupsList getCounteragentGroups(String boxId, @Nullable Integer page, @Nullable Integer count) throws DiadocSdkException {
        if (Tools.isNullOrEmpty(boxId)) {
            throw new IllegalArgumentException("boxId");
        }
        if(page != null && page < 1) {
    ...
    public CounteragentFromGroupResponseProtos.CounteragentFromGroupResponse getCounteragentsFromGroup(String boxId, String counteragentGroupId, @Nullable Integer count, @Nullable String afterIndexKey) throws DiadocSdkException {
        if(boxId == null) {
            throw new IllegalArgumentException("boxId");
        }
